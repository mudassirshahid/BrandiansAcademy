    ...
    */
    ...
    public function getSection()
    {
        ...
        if ((int)$id) {
            ...
            echo "<option value='0'>", $this->lang->line("online_exam_section_select"), "</option>";
    ...
    public function getSubject()
    {
        ...
        if ((int)$classID) {
            ...
            echo "<option value=''>", $this->lang->line("online_exam_subject_select"), "</option>";
