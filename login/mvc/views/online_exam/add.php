            ...
            <div class="col-sm-12">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                            $array = array(0 => $this->lang->line("online_exam_class_select"));
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                            $array = array(0 => $this->lang->line("online_exam_section_select"));
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                            $array = array(0 => $this->lang->line("online_exam_student_group_select"));
                            if(customCompute($groups)) {
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                            $array = array(0 => $this->lang->line("online_exam_subject_select"));
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                $array = array(0 => $this->lang->line("online_exam_instruction_select"));
                                if(customCompute($instructions)) {
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                            $randomArray['0'] = $this->lang->line("online_exam_select");
                            $randomArray['1'] = $this->lang->line("online_exam_yes");
                            $randomArray['2'] = $this->lang->line("online_exam_no");
                            echo form_dropdown("random", $randomArray, set_value("random"), "id='random' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_dropdown("published", $array, set_value("published",2), "id='published' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
